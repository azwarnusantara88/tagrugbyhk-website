  ...
  return (
    ...
    >
      ...
      <div className="hero-content relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center">
        {/* Tag Asia Cup Logo - Better mobile scaling */}
        <div className="hero-logo mb-3 md:mb-4 px-4">
          <img 
            src="/logo.png" 
            alt="Tag Asia Cup 2026" 
            className="w-32 h-auto sm:w-40 md:w-48 lg:w-56 object-contain drop-shadow-2xl max-w-full"
          />
        </div>

        {/* Title */}
        <div className="hero-title text-center mb-2 md:mb-4">
          <h1
        ...
        {/* Subtitle */}
        <div className="hero-subtitle text-center mb-4 md:mb-6 px-2">
        ...
        <div className="hero-countdown mb-4 md:mb-6">
        ...
        {/* Event Details */}
        <div className="hero-stats flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-6 mb-4 md:mb-6">
          {[
            { icon: Users, value: '16', label: 'Teams' },
            { icon: Trophy, value: '29', label: 'Matches' },
            { icon: Calendar, value: '4', label: 'Divs' },
          ].map((stat, index) => (
            <div
              key={index}
