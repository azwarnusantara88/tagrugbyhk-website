        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div ref={textGroupRef} className="space-y-6">
              <h2
                className="travel-text text-4xl sm:text-5xl lg:text-6xl text-[#0B3D2E] font-black"
              ...
              <p className="travel-text text-[#0B3D2E]/70 text-lg leading-relaxed max-w-lg">
              ...
              <div className="space-y-3">
                {travelInfo.map((info, index) => (
                  <div
                    key={index}
                    className="travel-text flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm"
                  >
                    <div className="w-10 h-10 rounded-full bg-[#CFFF2E]/20 flex items-center justify-center flex-shrink-0">
                      <info.icon className="w-5 h-5 text-[#0B3D2E]" />
                    </div>
                    <div>
              ...
              <button className="travel-text inline-flex items-center gap-2 px-6 py-3 bg-[#0B3D2E] text-white rounded-full font-semibold hover:bg-[#0B3D2E]/90 transition-colors">
            ...
            <div ref={mapCardRef} className="card-white overflow-hidden">
              <div className="p-6 lg:p-8">
                <h3
                  className="text-xl font-bold text-[#0B3D2E] mb-4"
                  style={{ fontFamily: 'League Spartan, sans-serif' }}
                >
                  Venue Map
                </h3>
                ...
                <div className="flex flex-wrap gap-2">
                  {locationChips.map((chip, index) => (
                    <div
                      key={index}
                      className={`map-chip inline-flex items-center gap-2 px-4 py-2 ${chip.color} rounded-full`}
                    >
                      <chip.icon className="w-4 h-4 text-[#0B3D2E]" />
                ...
                <a
                  ...
                  className="mt-4 inline-flex items-center gap-2 text-[#0B3D2E] font-medium hover:text-[#CFFF2E] transition-colors"
                >
                  Get Directions
