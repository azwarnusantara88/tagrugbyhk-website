...
const NewsArticlePage = () => {
  ...
  // Parse content and replace [IMAGE:X] markers with actual images
  const renderContent = (content: string, galleryImages: string[]) => {
  ...
  return (
    <div className="min-h-screen bg-[#0B3D2E]">
      ...
      <article className="px-4 sm:px-6 pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-white/80 text-base sm:text-lg leading-relaxed">
            {renderContent(article.content, article.galleryImages)}
          </div>
        </div>
      </article>
